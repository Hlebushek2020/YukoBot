...
extend-premium|ep|Продлить [премиум доступ](#премиум-доступ)|:heavy_check_mark:|:x:|:x:
...
status|stat|Сведения о боте|:heavy_check_mark:|:x:|:x:
