...
namespace YukoBot.Commands
{
    ...
    public class OwnerAndAdminCommandModule : CommandModule
    {
        private readonly YukoDbContext _dbContext;

        public OwnerAndAdminCommandModule(YukoDbContext dbContext) : base(
            Categories.Management,
            "Простите, эта команда доступна администратору гильдии и владельцу бота!")
        {
