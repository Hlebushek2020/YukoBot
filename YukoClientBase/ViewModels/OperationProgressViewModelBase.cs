...
{
    public abstract class OperationProgressViewModelBase : BindableBase, IProgress<ProgressReportArgs>
    {
        #region Fields
        ...
        protected OperationProgressViewModelBase(bool isCancellable = true)
        {
